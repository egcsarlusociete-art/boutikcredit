        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              _article('15', 'Vérification d\'identité par photo de la CNI',
                'Afin de garantir la véracité des informations fournies lors de la création du compte, l\'utilisateur est invité à fournir une photo de sa Carte Nationale d\'Identité (CNI). Deux photos sont requises : une pour le recto et une pour le verso. Cette mesure permet à EGC-SARLU de confirmer l\'identité de l\'utilisateur et de sécuriser les transactions. Cette action peut être effectuée avant ou après la signature des Conditions Générales et ne conditionne pas ladite signature.',
                warning: 'La vérification d\'identité est obligatoire pour tout passage de commande.'),
